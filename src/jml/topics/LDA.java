...
public class LDA extends TopicModel {
	...
	public static void main(String[] args) {
		...
		RealMatrix X = Corpus.documents2Matrix(documents);
	...
	public void train() {
		gibbsSampler.run();
		topicMatrix = new BlockRealMatrix(gibbsSampler.getPhi()).transpose();
		indicatorMatrix = new BlockRealMatrix(gibbsSampler.getTheta());
	}
	 ...
	 *          
	 */
	public void readCorpus(RealMatrix X) {
		dataMatrix = X;
